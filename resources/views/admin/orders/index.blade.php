                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 d-flex align-items-center gap-2">
                            <div class="btn-group mt-2">
                                <a href="#" class="btn btn-sm btn-info mb-2" title="Tambah Kegiatan Internal"
                                    data-toggle="modal" data-target="#addOrderModal">
                                    <i class="fas fa-plus me-1"></i>
                                </a>
                                <a href="{{ route('admin.orders.export') }}" title="Export Format Excel" target="_blank"
                                    class="btn btn-success btn-sm mb-2">
                                    <i class="fas fa-file-excel"></i>
                                </a>
                                <a href="{{ route('admin.orders.exportPdf') }}" title="Export Format PDF"
                        ...
                        <div class="col-md-6">
                            <form method="GET" class="d-flex justify-content-end align-items-center gap-2">
                                <input type="text" name="search" class="form-control form-control-sm"
                                    placeholder="Cari nama / kode order..." value="{{ request('search') }}"
                                ...
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @endphp
                                            <span
                                                class="badge bg-{{ $paymentColor }}">{{ ucfirst($order->payment_status) }}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @endphp
                                            <span
                                                class="badge bg-{{ $statusColor }}">{{ ucfirst($order->order_status) }}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            @if ($order->verifier)
                                                ...
                                                <small
                                                    class="text-muted">{{ $order->updated_at->format('d M Y H:i') }}</small>
                                            @else
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ url('admin/order-details/' . $order['id']) }}" class=""> <i
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateHarga() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $('#price_display').html('Rp ' + res.product_price + ' x ' + res.qty +
            ...
            $('#checkAvailability').click(function() {
                ...
                if (!productId) {
                    $('#availabilityResult').html(
                        '<span class="text-warning fw-bold">Pilih produk terlebih dahulu</span>');
                    return;
                }
