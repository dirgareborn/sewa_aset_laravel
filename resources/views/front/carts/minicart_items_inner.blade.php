...
@if (isset($cartItems) && $cartItems->count() > 0)
    ...
    @foreach ($cartItems as $item)
        ...
        <li class="dropdown-item d-flex justify-content-between align-items-start">
            ...
            <div>
                <a href="javascript:void(0)" class="deleteCartItem text-danger" data-cartid="{{ $item->id }}"
                    title="Hapus Produk">
        ...
        @endif
    @endforeach
    <li class="divider text-orange"></li>
    <li>
        <a class="dropdown-item" href="{{ url('cart') }}">Lihat Keranjang</a>
    </li>
@else
