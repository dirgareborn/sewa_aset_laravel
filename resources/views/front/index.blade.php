            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    ...
                    <p class="mb-3 text-muted small">
                        <button 
                        class="btn btn-directions d-inline-flex align-items-center"
                        id="btnDirections"
                        data-lat="{{ $latitude }}"
                        data-lng="{{ $longitude }}" 
                        title="Petunjuk Arah" 
                        >
                        <i class="fas fa-map-marker-alt me-2"></i> {{ $product['locations']['name'] }}
                    </button>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card h-100 overflow-hidden position-relative" style="min-height: 220px;">
                ...
                class="card-img-top transition w-100 h-100" alt="{{ $info->title }}" style="object-fit: cover;">
                <div class="card-body">
